...
!(function (t) {
    ...
    function o(i) {
      ...
      function a(t) {
        if (
          ...
          var P = e(i.height);
          return (
            P !== !1 && (r.height = P + (C ? 0 : m + w)),
            (r.innerWidth = r.width - (g + x)),
            (r.innerHeight = r.height - (m + w)),
            (r.outerWidth = r.width + b),
            (r.outerHeight = r.height + S),
            r
          );
        }
      }
        ...
        for (var o = [], r = 0, s = t.length; s > r; r++) {
          ...
          if (n.isElement(a))
            if (e) {
              i(a, e) && o.push(a);
              for (
                var l = a.querySelectorAll(e), c = 0, h = l.length;
                h > c;
                c++
              )
                o.push(l[c]);
    ...
    return (
      (c.positionSlider = function () {
        ...
        this.options.wrapAround &&
          ...
          (t = this.options.rightToLeft && h ? -t : t);
  ...
  (function (t, e) {
    ...
    (c.defaults = {
      ...
      (c.prototype._init = c.prototype.reposition =
        function () {
      ...
      (c.prototype._containCells = function () {
        if (
          ...
          for (
            ...
            c.setDefaultTarget(),
              s
                ? (c.target = o * this.cellAlign)
                : ((c.target = Math.max(c.target, this.cursorPosition + i)),
                  (c.target = Math.min(c.target, r)));
          }
      }),
  ...
  (function (t, e) {
    ...
    (r.prototype.pointerDown = function (i, n) {
      ...
      (r.prototype._dragStart = function (t, e) {
        (this.isDragging = !0),
          (this.dragStartPoint = r.getPointerPoint(e)),
  ...
  (function (t, e) {
    ...
    return (
      (n.prototype.touchVerticalScrollMove = function (e, i, n) {
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ...
      : e(t.EventEmitter, t.eventie, t.Flickity);
  })(window, function (t, e, i) {
    function n(t) {
    ...
    return (
      ...
      (e.prototype.cellChange = function (t, e) {
        ...
        this._positionCells(t),
          ...
          this.setGallerySize(),
          this.options.freeScroll
            ? ((this.x += i - this.slideableWidth), this.positionSlider())
  ...
  (function (t, e) {
    ...
    (s.prototype = new e()),
      ...
      (s.prototype.check = function () {
        function t(t, o) {
          return (
            e.options.debug && p && h.log("confirm", t, o),
            e.progress(t),
            i++,
            i === n && e.complete(),
            !0
