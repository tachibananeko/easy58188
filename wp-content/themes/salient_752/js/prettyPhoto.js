...
(function ($) {
  ...
  $.fn.prettyPhoto = function (pp_settings) {
    pp_settings = jQuery.extend(
      {
        ...
        iframe_markup:
          '<iframe src ="{path}" width="{width}" height="{height}" onload="setTimeout(resizeIframe);" frameborder="no" allowfullscreen></iframe>',
    ...
    $.prettyPhoto.close = function () {
      ...
      $(
        "div.pp_pic_holder,div.ppt,.pp_fade, div.pp_details, .pp_loaderIcon"
      ...
      setTimeout(function () {
        if (typeof settings.hideflash != "undefined" && settings.hideflash)
          $("object,embed,iframe[src*=youtube],iframe[src*=vimeo]").css(
            "visibility",
            "visible"
          ); // Show the flash
