...
function getSizeName() {
  ...
  return screen_w > 1170
    ? "desktop_wide"
    : screen_w > 960 && 1169 > screen_w
    ? "desktop"
    : screen_w > 768 && 959 > screen_w
    ? "tablet"
    : screen_w > 300 && 767 > screen_w
    ? "mobile"
    : 300 > screen_w
    ? "mobile_portrait"
    : "";
...
function vc_accordionActivate(event, ui) {
  if (ui.newPanel.length && ui.newHeader.length) {
    ...
    "undefined" != typeof jQuery.fn.isotope &&
    ...
    (window.vc_teaserGrid = function () {
      ...
      jQuery(
        ...
        $thumbs.isotope({
          ...
          layoutMode:
            "undefined" == typeof layout_modes[layout_mode]
              ? "fitRows"
